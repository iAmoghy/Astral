...
if (basic != 1 || nav != 1 || layer2 != 1 || layer3 != 1) {
    $('#purchaseText').text('Upgrade not unlocked 🔒');
    $('#purchase').prop('disabled', true);
}

if (astrallite < layer4Cost) {
...
$('#purchase').on('click', function () {
    ...
    layer4 = 1
    $('#purchaseText').text('Already purchased ✔️');
    $('#purchase').prop('disabled', layer4==1);


    // console.log(astrallite);

    astrallite -= layer4Cost;
    ...
    localStorage.setItem("layer4", layer4);
